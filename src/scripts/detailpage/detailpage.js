...
import {
    flag
} from 'country-emoji' // Only library used to prevent a lot of time making a dictionary for all the country flags
...
export const detailPage = async (itemId, search, popState) => {
    ...
    if (productInfo) {
        ...
        detailPageImage.src = product.image_front_url ? product.image_front_url : "assets/images/eaten-apple.png"
